...
<form class="search-form" onsubmit="openModal(event)">
    ...
    <ul>
        ...
        <li class="dropdown">
                    <a href="index.php#maps"><span>Maps & Books</span><i class="bi bi-chevron-down toggle-dropdown"></i></a>
                    <ul>
...
<script>
    ...
    <div class="container">
        ...
        <div class="row gy-4">
        <h2 style="font-weight: bold; text-align: center; display: block; margin-top: 6%;">Maps</h2>
   <?php
include 'db.php'; 
    ...
    $sql_products = "SELECT name, img, price FROM maps ";
